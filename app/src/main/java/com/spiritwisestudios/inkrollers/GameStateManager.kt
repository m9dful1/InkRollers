...
class GameStateManager(private val context: Context) {
    ...
    data class GameState(
        ...
        val robotSpawnersEnabled: Boolean,
        val robotSpawnerCount: Int,
        val isHost: Boolean,
        val playerColor: Int?,
    ...
    fun saveActiveGameState(
        ...
        robotSpawnersEnabled: Boolean,
        robotSpawnerCount: Int,
        isHost: Boolean,
        playerColor: Int?,
        playerName: String,
        playerUid: String
        ...
        try {
            val gameState = GameState(
                ...
                robotSpawnersEnabled = robotSpawnersEnabled,
                robotSpawnerCount = robotSpawnerCount,
                isHost = isHost,
